...
public class NewsDAO extends BaseHibernateDAO {
	...
	public News findById(java.lang.Integer id) {
		...
		try {
			News instance = (News) getSession().get("com.kate.app.model.News",
					id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(News instance) {
		...
		try {
			List results = getSession()
					.createCriteria("com.kate.app.model.News")
	...
	public List findByNewsDetail(Object newsDetail) {
		return findByProperty(NEWS_DETAIL, newsDetail);
	}
