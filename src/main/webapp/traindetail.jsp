...
<div class="container">
		...
		<div id="id1" style="padding-top:100px;font-size:30px;font-weight:bolder;font-family:黑体;filter:alpha(opacity=60);opacity:0.6;cursor:pointer;">舞蹈班</div>
		<div id="id2" style="padding-top:100px;font-size:30px;font-weight:bolder;font-family:黑体;filter:alpha(opacity=60);opacity:0.6;cursor:pointer;">艺术班</div>
		<div id="id3" style="padding-top:100px;font-size:30px;font-weight:bolder;font-family:黑体;filter:alpha(opacity=60);opacity:0.6;cursor:pointer;">唱歌班</div>
		<div id="id4" style="padding-top:100px;font-size:30px;font-weight:bolder;font-family:黑体;filter:alpha(opacity=60);opacity:0.6;cursor:pointer;">练习班</div>
		</div>		
		</div>
